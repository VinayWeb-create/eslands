...
import {
  ...
  CheckCircle2, ArrowUpRight, Activity, Terminal, LucideIcon
} from 'lucide-react';
...
const standardCapabilities: StandardCapability[] = [
  {
    id: 'arch',
...
export default function EnterpriseStandard() {
  const [activeCap, setActiveCap] = useState<StandardCapability>(standardCapabilities[0]);
