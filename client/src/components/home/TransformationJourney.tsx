...
import {
  Cpu, ArrowRight, Zap, RefreshCw, AlertTriangle, CheckCircle2
} from 'lucide-react';
...
const transformationDimensions: TransformationDimension[] = [
  {
    id: 'cloud',
...
export default function TransformationJourney() {
  const [activeDimension, setActiveDimension] = useState<TransformationDimension>(transformationDimensions[0]);
