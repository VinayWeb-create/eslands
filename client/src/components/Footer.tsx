        ...
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3 text-xs text-slate-400 font-medium">
              ...
              <li>
                <a href="/contact" className="hover:text-sky-400 transition-colors">Privacy Policy</a>
              </li>
              <li>
                <a href="/contact" className="hover:text-sky-400 transition-colors">Terms of Service</a>
              </li>
            </ul>
          </div>
