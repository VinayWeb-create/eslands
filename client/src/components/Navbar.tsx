...
import {
  ...
  Code, Smartphone, Server, Shield, Palette, TrendingUp, ShoppingCart, RotateCcw, LucideIcon
} from 'lucide-react';
...
const serviceIcons: Record<string, LucideIcon> = { Code, Smartphone, Server, Shield, Palette, TrendingUp, ShoppingCart, RotateCcw };
              ...
              return (
                ...
                >
                  ...
                  {item.hasDropdown ? (
                    ...
                    >
                      <button
                        className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold tracking-wider transition-colors duration-200 rounded-xl uppercase text-slate-300 hover:text-white"
                      >
                        {item.label}
                    ...
                    <a
                      href={item.path}
                      className="relative z-10 block px-4 py-2 text-xs font-bold tracking-wider uppercase rounded-xl transition-colors duration-200 text-slate-300 hover:text-white"
                    >
                      {item.label}
                    </a>
                  )}
